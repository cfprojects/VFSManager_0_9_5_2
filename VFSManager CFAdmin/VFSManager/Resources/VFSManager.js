...
var doViewFile = function(selectedFile, delFile){
	window.open("./Resources/DownloadFile.cfm?filename=" + selectedFile + '&delFile=' + delFile, "dliframe");
}
...
var deleteFileRes = function(res){
	if (res) {
		...
		ColdFusion.navigate('./Resources/Content.cfc?method=getContent&dir=&reloadLast=1', 'bodyDiv');		
	} else {
